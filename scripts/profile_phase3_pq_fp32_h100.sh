#!/bin/bash
#SBATCH --job-name=p3_pq_fp32
#SBATCH --output=logs/phase3_pq_fp32_%j.out
#SBATCH --error=logs/phase3_pq_fp32_%j.err
...
echo "========================================"
echo "Phase 3 PARQUET FP32 BASELINE batch_size=4096 (h100)"
echo "========================================"
